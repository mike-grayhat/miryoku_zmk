...
// Replace &none with actual keycodes for the outer columns
// Left outer column maps to keys left of QAZ
// Right outer column maps to keys right of P;/
#define XXX_LEFT &kp ESC  // Left column (can be customized)
#define CAPS_42 &kp CAPS  // Right column (can be customized)
...
&kp ESC  K00  K01  K02  K03  K04       K05  K06  K07  K08  K09  &kp LBKT \
&kp TAB  K10  K11  K12  K13  K14       K15  K16  K17  K18  K19  &kp SQT \
&kp CAPS K20  K21  K22  K23  K24       K25  K26  K27  K28  K29  &kp RBKT \
